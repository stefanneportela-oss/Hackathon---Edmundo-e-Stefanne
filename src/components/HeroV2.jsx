...
export default function HeroV2() {
  return (
    ...
    >
      {/* ===== Center anchor: radial spotlight + 3D hologram ===== */}
      ...
      {/* 3D hologram — centered, sits above the aura but below the text/cards */}
      <div className="pointer-events-none absolute inset-0 z-[1] flex items-center justify-center">
        <div className="relative aspect-square w-full max-w-[460px] sm:max-w-[560px] lg:max-w-[640px]">
          <Suspense
            fallback={
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-7xl flex-col gap-12 px-4 sm:px-6 lg:grid lg:min-h-[70vh] lg:grid-cols-2 lg:items-stretch lg:gap-8 lg:px-8">
        ...
        <div className="flex flex-col justify-between">
          ...
          <div
            className="animate-fade-up mt-10 flex items-center gap-3 lg:mt-0"
        ...
        <div className="flex flex-col items-end justify-between text-right">
          ...
          <div
            className="animate-fade-up mt-10 w-full max-w-sm lg:mt-0"
